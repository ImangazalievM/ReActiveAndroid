...
public class UpdateTest extends BaseTest {
    ...
    public void testUpdate() {
        TestUtils.assertSqlEquals(UPDATE_PREFIX, update());
    }

    @Test
    public void testUpdateSet() {
        TestUtils.assertSqlEquals(UPDATE_PREFIX + " SET id = 5", update().set("id = 5"));
    }

    @Test
    public void testUpdateWhereNoArguments() {
        TestUtils.assertSqlEquals(UPDATE_PREFIX + " SET id = 5 WHERE id = 1", update().set("id = 5").where("id = 1"));
    }
